...
{
    public partial class Portimao_PraiaDoAlvor : System.Web.UI.Page
    {
        ...
        protected void EnviarTesos_Click(object sender, EventArgs e)
        {
            ...
            System.IO.Directory.CreateDirectory("C://temp//praiadoalvor");
            novoficheiro.CriarComentarioFile("C://temp//praiadoalvor//coment.txt", lttesos.Text);
            lttesos.Text = "";
        }
        ...
        protected void btnvertesos_Click(object sender, EventArgs e)
        {
            ...
            string path = "C://temp//praiadoalvor//coment.txt";
