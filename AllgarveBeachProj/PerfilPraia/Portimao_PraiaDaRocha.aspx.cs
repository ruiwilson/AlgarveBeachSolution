...
{
    public partial class Portimao_PraiaDaRocha : System.Web.UI.Page
    {
        ...
        protected void EnviarTesos_Click(object sender, EventArgs e)
        {
            ...
            System.IO.Directory.CreateDirectory("C://temp//praiarocha");
            fi.CriarComentarioFile("C://temp//praiarocha//coment.txt", lttesos.Text);
            lttesos.Text = "";
        }
        ...
        protected void btnvertesos_Click(object sender, EventArgs e)
        {
            ...
            string path = "C://temp//praiarocha//coment.txt";
