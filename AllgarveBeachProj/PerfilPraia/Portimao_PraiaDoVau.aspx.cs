...
{
    public partial class Portimao_PraiaDoVau : System.Web.UI.Page
    {
        Ficheiros fic = new Ficheiros();
        ...
        protected void EnviarTesos_Click(object sender, EventArgs e)
        {
            ...
            System.IO.Directory.CreateDirectory("C://temp//praiavau");
            fic.CriarComentarioFile("C://temp//praiavau//coment.txt", lttesos.Text);
            lttesos.Text = "";
        }
        ...
        protected void btnvertesos_Click(object sender, EventArgs e)
        {
            ...
            string path = "C://temp//praiavau//coment.txt";
